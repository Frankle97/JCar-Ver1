...
public class MyCar_UserInfo_DTO {
	...
	public MyCar_UserInfo_DTO(int price) {
		this.price += price;
	}

	public MyCar_UserInfo_DTO(String incolor, String outcolor, String option) {
		super();
		this.incolor = incolor;
		this.outcolor = outcolor;
		this.option = option;
	...
	public MyCar_UserInfo_DTO(String id, String pw, String name, String phonenumber, String when) {
		super();
		this.id = id;
		this.pw = pw;
		this.name = name;
