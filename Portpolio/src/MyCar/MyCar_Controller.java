...
class MyCar_Controller {
	Calendar cal = Calendar.getInstance();
	static ArrayList<MyCar_UserInfo_DTO> users = new ArrayList<>();
	...
	void add(String id, String pw, String name, String number, String when) {
		users.add(new MyCar_UserInfo_DTO(id, pw, name, number, when));
	}
